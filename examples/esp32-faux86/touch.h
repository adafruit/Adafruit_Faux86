...
#define TOUCH_MODULE_ADDR                                                      \
  GT911_SLAVE_ADDRESS1 // CTS328_SLAVE_ADDRESS / L58_SLAVE_ADDRESS /
                       ...
                       // CTS816S_SLAVE_ADDRESS / FT3267_SLAVE_ADDRESS /
                       // FT5x06_ADDR / GT911_SLAVE_ADDRESS1 /
                       // GT911_SLAVE_ADDRESS2 / ZTW622_SLAVE1_ADDRESS /
                       // ZTW622_SLAVE2_ADDRESS
#define TOUCH_SCL 8
#define TOUCH_SDA 18
#define TOUCH_RES -1
#define TOUCH_INT 16
...
void touch_init(int16_t w, int16_t h, uint8_t r) {
  ...
  delay(200);
#endif
  Wire.begin(TOUCH_SDA, TOUCH_SCL, 800000UL);
  touch.init();
...
void translate_touch_raw() {
  ...
  // Serial.printf("touch_raw_x: %d, touch_raw_y: %d, touch_last_x: %d,
